...
def read_input_arguments
  ...
  raise ArgumentError, 'Argument is not an integer value between 1 and 100,000' unless river_width.is_a?(Integer) && river_width >= MIN_RIVER_WIDTH && river_width <= MAX_RIVER_WIDTH
